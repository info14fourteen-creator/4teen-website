...
const appContentRu: AppPageContent = {
  ...
  storeLinks: [{ href: "https://apps.apple.com/", label: "App Store", meta: "Загрузить для iPhone и iPad" }, { href: "https://play.google.com/store/apps/details?id=me.fourteen.wallet", label: "Google Play", meta: "Загрузить для Android" }],
...
const appContentUz: AppPageContent = {
  ...
  storeLinks: [{ href: "https://apps.apple.com/", label: "App Store", meta: "iPhone va iPad uchun yuklash" }, { href: "https://play.google.com/store/apps/details?id=me.fourteen.wallet", label: "Google Play", meta: "Android uchun yuklash" }],
