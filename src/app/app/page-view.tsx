            ...
            <div className="ft-stack ft-stack--lg">
              <div className="ft-buy-page__hero-layout">
                <div className="ft-stack ft-stack--md ft-buy-page__hero-copy">
                  ...
                  <ReleaseCountdown
                    className="ft-app-page__release-module"
                    description="The countdown disappears on its own after the target date. Until then, this page is the cleanest place to follow the dual-store launch without losing the broader wallet and protocol context."
                    eyebrow="Release Window"
                    primaryHref="#app-download"
                    primaryLabel="Jump to Download"
                    secondaryHref="#app-protocol-surfaces"
                    secondaryLabel="See Wallet Surfaces"
                    title="App Store and Google Play are scheduled to open on July 25, 2026."
                    variant="app"
                  />
                  ...
                  <div className="ft-stack ft-stack--md ft-buy-page__hero-side-inner">
                    ...
                    <div className="ft-actions ft-actions--stack-mobile ft-buy-page__hero-side-actions">
                      {content.hero.primaryCta ? (
                        <LoaderLink className="ft-btn ft-btn--primary" href="#app-download">
                          {content.hero.primaryCta}
                        </LoaderLink>
                      ) : null}
                      {content.hero.secondaryCta ? (
                        <LoaderLink className="ft-btn ft-btn--secondary" href="#app-protocol-surfaces">
                          {content.hero.secondaryCta}
                        </LoaderLink>
                      ) : (
